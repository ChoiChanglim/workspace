...
public class HttpWebURLConnection {
    ...
    // HTTP GET request
    public HttpWebURLResponse sendGet() throws Exception {
	...
	// HTTP POST request
	public HttpWebURLResponse sendPost() throws Exception {
	...
	// HTTP POST request
    public HttpWebURLResponse sendPostByParamTypeJson() throws Exception {
        URL obj = new URL(dest);
        HttpURLConnection con = (HttpURLConnection) obj.openConnection();
