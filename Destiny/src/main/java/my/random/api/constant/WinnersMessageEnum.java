...
public enum WinnersMessageEnum {
	...
	public static WinnersMessageEnum GetWinnersMessage(int grade){
		if(grade == 5){
			...
			WinnersMessageEnum winnersMessageEnum = GetWinnersMessageEnum("NORMAL", no);
		...
		if(grade == 4){
			...
			WinnersMessageEnum winnersMessageEnum = GetWinnersMessageEnum("LITTLE", no);
			return winnersMessageEnum;
		...
		if(grade == 3){
			...
			WinnersMessageEnum winnersMessageEnum = GetWinnersMessageEnum("LUCK", no);
			return winnersMessageEnum;
		}
		
		if(grade == 2){
			int no = NumberUtil.randomRange(1, 3);
			WinnersMessageEnum winnersMessageEnum = GetWinnersMessageEnum("GREAT", no);
			return winnersMessageEnum;
		}
		
		if(grade == 1){
			int no = NumberUtil.randomRange(1, 5);
			WinnersMessageEnum winnersMessageEnum = GetWinnersMessageEnum("VERY", no);
			return winnersMessageEnum;
		}
		
		return WinnersMessageEnum.NORMAL_1;
	}
}
